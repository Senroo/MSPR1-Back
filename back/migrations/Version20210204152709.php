 ...
 */
final class Version20210204152709 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE concert (id INT AUTO_INCREMENT NOT NULL, artist_id INT NOT NULL, stage_id INT NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, genre VARCHAR(255) NOT NULL, start_date DATETIME NOT NULL, duration TIME NOT NULL, INDEX IDX_D57C02D22298D193 (stage_id), INDEX IDX_D57C02D2B7970CF8 (artist_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
